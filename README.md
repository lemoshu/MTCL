...
- [Note] We are working on an extended version, 3D version and other datasets will be included that time. This's an initial report, code will be further re-organized. The preprocessed 2D hepatic data and other simulated 3D benchmark data will be available after journal publication. Stay tuned!
____
## Abstract
